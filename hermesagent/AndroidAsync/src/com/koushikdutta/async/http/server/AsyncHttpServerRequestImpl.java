...
import com.koushikdutta.async.ContentTypeEncodingEmitter;
...
//            mBody.onCompleted(e);
    ...
    StringCallback mHeaderCallback = new StringCallback() {
        ...
        public void onStringAvailable(String s) {
            ...
            //weijia_flag 替换
            ContentTypeEncodingEmitter contentTypeEncodingEmitter  = new ContentTypeEncodingEmitter(mRawHeaders);
            contentTypeEncodingEmitter.setDataEmitter(emitter);
            emitter = contentTypeEncodingEmitter;
